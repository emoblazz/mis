...
<head>
  ...
  <title><?php include '../dist/includes/title.php';?> | Supplies</title>
            ...
            <div class="card card-danger shadow-lg">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Name of Supply" name="name" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="exampleInputEmail1" placeholder="Enter of Measure (pc/s,box)" name="unit" required>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Reorder Point</label>
                    <input type="number" class="form-control" id="exampleInputEmail1" placeholder="Enter Subject" name="reorder" required>
                </div>
              ...
              <div class="card-footer bg-transparent">
                <div class="row">
                  <div class="col-12 text-center">
                    <button type="submit" class="btn btn-success btn-block" name="add_supply"><i class="fa fa-save"></i> Save</button>
                  </div>
                </div>
                <!-- /.row -->
              </div>
