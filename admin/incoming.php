...
<head>
  ...
  <title><?php include '../dist/includes/title.php';?> | Incoming Documents</title>
                          ...
                          <div class="modal-content">
                            <form method="post" action="functions.php">
                              ...
                              <div class="modal-footer justify-content-between">
                                ...
                                <button type="submit" class="btn btn-success" name="update_incoming">Save changes</button>
                              </div>
                            </form>
                          </div>
                          <!-- /.modal-content -->
                        ...
                        <div class="modal-dialog">
                          <div class="modal-content">
                            <form method="post" action="functions.php">
                              ...
                              <div class="modal-footer justify-content-between">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                <button type="submit" class="btn btn-success" name="delete_incoming">Delete</button>
                              </div>
                            </form>
                          </div>
                          <!-- /.modal-content -->
