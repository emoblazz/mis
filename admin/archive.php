...
<head>
  ...
  <title><?php include '../dist/includes/title.php';?> | Archived</title>
                            ...
                            <form method="post" action="functions.php" enctype='multipart/form-data'>
                              ...
                              <div class="modal-body">
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-8">
                                    <input type="text" class="form-control" id="inputEmail3" placeholder="Enter Form Title" name="title" value="<?php echo $title;?>" required>
                                ...
                                <div class="form-group row">
                                  <label for="exampleInputFile" class="col-sm-4 col-form-label">File/s</label>
                                  <div class="input-group col-sm-8">
                                    ...
                                    ?>
                                        ...
                                        <a href="../dist/uploads/<?php echo $file;?>" class="text-danger"><?php echo $file;?> x </a> <br><br>
                                    <?php }?>
                              ...
                              <div class="modal-footer justify-content-between">
                                ...
                                <button type="submit" class="btn btn-success" name="update_form">Save changes</button>
                              </div>
                            </form>
                          </div>
                          <!-- /.modal-content -->
                ...
                <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="custom-file">
                            <input type="file" class="custom-file-input" id="exampleInputFile" name="file[]" multiple="true" required>
              ...
              <div class="card-footer bg-transparent">
                <div class="row">
                  <div class="col-12 text-center">
                    <button type="submit" class="btn btn-success btn-block" name="add_archive"><i class="fa fa-save"></i> Save</button>
                  </div>
                </div>
                <!-- /.row -->
              </div>
