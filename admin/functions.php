...
if (isset($_POST['add_incoming']))
{
	...
	$type=$_POST['type'];
		...
		mysqli_query($con,"INSERT INTO doc(doc_name,doc_subject,doc_desc,doc_remarks,doc_date,admin_id,doc_type) VALUES('$name','$subject','$desc','$remarks','$date','$id','$type')")or die(mysqli_error());  
...
{	
	...
	mysqli_query($con,"INSERT INTO service_record(user_id,service_from,service_to,designation,status,salary,station,branch,service_remarks) VALUES('$id','$from','$to','$designation','$status','$salary','$station','$branch','$remarks')")or die(mysqli_error($con));  
