...
<head>
  ...
  <title><?php include '../dist/includes/title.php';?> | Stockin</title>
            ...
            <div class="card card-outline card-success">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  $query=mysqli_query($con,"select * from stockin natural join supply natural join admin order by stockin_date desc")or die(mysqli_error());
                    $i=0;
